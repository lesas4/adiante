...
echo "    ├─ VERCEL_PROJECT_ID_STAGING (Vercel Project Settings)"
echo "    ├─ RAILWAY_TOKEN         (https://railway.app/account/tokens)"
echo "    ├─ RAILWAY_PROJECT_ID    (Railway Dashboard)"
echo "    ├─ RAILWAY_PROJECT_ID_STAGING (Railway Dashboard)"
...
echo "    4. Cole em .env: NEW_RELIC_LICENSE_KEY=..."
echo ""
...
echo "    ├─ IMPLEMENTATION_SUMMARY.md (4 implementações)"
