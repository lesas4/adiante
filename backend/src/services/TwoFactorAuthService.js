...
class TwoFactorAuthService_Auto_231 {
  /**
  ...
  static encryptSecret(secret) {
    const encryptionKey = process.env.ENCRYPTION_KEY || 'TwoFactorAuthService_Auto_231!';
...
module.exports = TwoFactorAuthService_Auto_231;
