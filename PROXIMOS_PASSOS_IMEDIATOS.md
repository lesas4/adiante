...
## 2️⃣ GERAR PIX_WEBHOOK_SECRET (5 min)
...
# Você verá algo como:
# 3f8d5e2a1b9c6f4e7a3d5c8f1b4e6a9d2c5f8b1e4a7d0c3f6e9a2b5d8c1f4
...
### Salvar Em:
```
Arquivo: PIX_WEBHOOK_SECRET.txt (no seu PC, NÃO no repo)
Conteúdo: 3f8d5e2a1b9c6f4e7a3d5c8f1b4e6a9d2c5f8b1e4a7d0c3f6e9a2b5d8c1f4
...
- [ ] 6. Registrar Webhook no Banco
  ...
  - Secret: PIX_WEBHOOK_SECRET (gerado lá em cima)
  - Testar webhook
...
[ ] PIX_WEBHOOK_SECRET gerado
[ ] PIX_WEBHOOK_SECRET guardado em lugar seguro
...
| Gerar PIX_WEBHOOK_SECRET | 2 min | 🔴 CRÍTICA |
...
```
ARQUIVO: credentials_leidy_cleaner.txt
...
PIX_WEBHOOK_SECRET: 3f8d5e2a1b9c6f4e7a3d5c8f1b4e6a9d...
