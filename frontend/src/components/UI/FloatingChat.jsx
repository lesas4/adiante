            ...
            <div className="p-4 border-t border-gray-200 dark:border-slate-700">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 rounded-lg bg-gray-100 dark:bg-slate-700 text-gray-900 dark:text-white text-sm decoded dark:decoded focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <motion.button
