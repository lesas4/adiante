...
import { CloudIcon, ArrowDownTrayIcon, ArrowUpTrayIcon, ClockIcon, CheckCircleIcon, decoded } from '@heroicons/react/24/outline';
...
const BackupSystem = () => {
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      case 'failed': return <decoded className="w-4 h-4" />;
